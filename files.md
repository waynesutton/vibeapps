...
- `convex/http.ts`: HTTP actions for external requests, Resend webhook handler, and Agent Ready component routes (agents.md, llms-full.txt, llms-status; /llms.txt and /robots.txt skipped since the app serves them from siteFiles)
