...
const AlertDialog: React.FC<AlertDialogProps> = ({
  ...
  if (confirmButtonVariant === "destructive") {
    confirmButtonClasses += " bg-red-600 hover:bg-red-700 text-white focus:ring-red-500";
  } else {
    confirmButtonClasses += " bg-black hover:bg-gray-800 text-white focus:ring-gray-700";
  }
  ...
  return (
    <div
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 w-full max-w-md m-4 transform transition-all duration-300 ease-in-out scale-100">
        ...
        <div id="alert-dialog-description" className="text-sm text-gray-600 mb-6">
          {description}
        </div>
        <div className="flex justify-end space-x-3">
          ...
          <button onClick={onConfirm} type="button" className={confirmButtonClasses}>
            {confirmButtonText}
          </button>
        </div>
      </div>
