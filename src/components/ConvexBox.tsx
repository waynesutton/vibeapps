...
export function ConvexBox() {
  ...
  return (
    <div
      ...
      className="fixed inset-x-3 bottom-3 h-auto max-h-[40vh] sm:inset-x-auto sm:right-4 sm:bottom-4 sm:w-[350px] sm:h-[var(--convex-box-h)] sm:max-h-none bg-surface-alt border border-hairline rounded-lg p-4 shadow-sm flex flex-col justify-center items-center text-center overflow-hidden"
      style={
        {
