          ...
          {!conversations || conversations.length === 0 ? (
            ...
            conversations.map((conversation) => (
              <button
                ...
                className={`w-full p-4 border-b bg-[#F2F4F7] hover:bg-gray-50 text-left transition-colors ${
                ...
                <div className="flex items-start justify-between">
                  ...
                  {conversation.unreadCount > 0 && (
                    <div className="ml-2 flex-shrink-0">
                      <div className="bg-[#292929] text-white text-xs rounded-full w-5 h-5 flex items-center justify-center">
              ...
              >
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#292929] focus:border-transparent"
                    maxLength={2000}
                    disabled={isSending}
                  />
                  <button
                    ...
                    className="px-6 py-2 bg-black text-white rounded-md hover:bg-gray-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center gap-2"
                  >
                    {isSending ? (
